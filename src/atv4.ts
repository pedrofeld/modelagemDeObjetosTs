...
class Calculadora {
    ...
    multiplicacao(valor1: number, valor2: number): number {
      const resultado = valor1 * valor2;
      this.adicionarHistorico(`${valor1} * ${valor2} = ${resultado}`);
      return resultado;
    }
  
    divisao(valor1: number, valor2: number): number {
      if (valor2 === 0) {
    ...
    subtracao(valor1: number, valor2: number): number {
      const resultado = valor1 - valor2;
      this.adicionarHistorico(`${valor1} - ${valor2} = ${resultado}`);
      return resultado;
    }
  
    private adicionarHistorico(operacao: string): void {
